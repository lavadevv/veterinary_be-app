<template>
  <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-3 md:p-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
      <!-- Left: search and default controls -->
      ...
      <div class="flex items-center gap-2">
        <slot name="right" />
        <button @click="onResetClick" class="inline-flex items-center justify-center px-3 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50">
          Reset
        </button>
      </div>
    </div>
