...
public interface ProductBatchService {
    ...
    CalcBatchRes calc(CalcBatchReq req);
    ProductBatchDto createDraft(CreateBatchReq req); // tính lại + lưu ProductBatch (chưa issue NVL)

    void cancelBatch(CancelBatchRequest request);
}